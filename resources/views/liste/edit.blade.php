...
<form method="post" action="{{route('liste.update',$liste)}}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="Avec" value="{{$liste->Reunion}}"/>
    </div>

    <div class="form-group">
        <label for="Debut">Date de début:</label>
        <input type="datetime" class="form-control" name="Debut" value="{{$liste->Debut}}"/>
    </div>

    <div class="form-group">
        <label for="Fin">Date de fin:</label>
        <input type="datetime" class="form-control" name="Fin" value="{{$liste->Fin}}"/>
    </div>

    <div class="form-group">
        <label for="Rapport">Rapport de réunion:</label>
        <input type="textarea" class="form-control" name="Rapport" value="{{$liste->Rapport}}"/>
    </div>
